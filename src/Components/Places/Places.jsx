    ...
    <div className={classes.bcg}>
      <Slide direction="left" in={true} mountOnEnter unmountOnExit>
        <Container className={classes.root}>
          <Typography className={classes.title} variant='h2'>Miejsca</Typography>
          ...
          <Paper className={classes.textPaper} elevation={0}>
            ...
            <Typography variant='body1' align='justify'>To tutaj wszystko się zaczęło.... W roku szkolnym 91/92 trafiliśmy w to miejsce za sprawą nauczycielki muzyki z technikum Jędrka, która jednocześnie tu pracowała. Na pierwszą próbę
